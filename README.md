...
## How to Install
Clone the repository and run `npm install`. Run `mongod` to activate the MongoDB. Then run `npm start` and your browser will automatically open to localhost:5000

## Deployment
This app is deployed on Heroku on https://powerful-tundra-56533.herokuapp.com/